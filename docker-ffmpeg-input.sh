...
-i $audioVideoUrl"?overlays=all&resolution=1920x1080&audio=1&video=1&compression=30&videocodec=h264&h264profile=main&fps=30&videokeyframeinterval=60&videobitrate=2800&videomaxbitrate=4000&audioencoding=aac&videobitrate=$bitrate&videomaxbitrate=$maxBitrate" \
